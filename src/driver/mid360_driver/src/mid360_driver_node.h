...
namespace mid360_driver {
    ...
    private:
        ...
        double min_timestamp_to_publish = 0.0;  // 缓存的最小时间戳
        bool is_init = false;
        ...
        // 缓存的 PointField 定义，避免每次发布都重建
        static std::vector<sensor_msgs::msg::PointField> cached_point_fields_;
        static bool fields_initialized_;

    public:
        LidarPublisher() = default;

        static void initializePointFields();
